...
class TestFileHandler(unittest.TestCase):
    def setUp(self):
        self.place_name = "San Sebastian, Guipuzcoa, Spain"
    ...
    def test_get_filename(self):
        expected_filename = "San_Sebastian-Guipuzcoa-Spain.graphml"
        self.assertEqual(self.file_handler.getFilename(), expected_filename)

    def test_get_full_path(self):
        expected_full_path = "local_maps/San_Sebastian-Guipuzcoa-Spain.graphml"
        self.assertEqual(self.file_handler.getFullPath(), expected_full_path)
